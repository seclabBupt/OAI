...
#define CONFIG_HLP_OTFS          "Turn on the OTFS modulation mode for NR\n"
...
#define OTFS                softmodem_params.otfs
...
#define CMDLINE_PARAMS_DESC {  \
    ...
    {"otfs",                 CONFIG_HLP_OTFS,        PARAMFLAG_BOOL, iptr:&OTFS,                      defintval:0,             TYPE_INT, 0}, \
  }
...
#define SOFTMODEM_OTFS_BIT            (1<<24)
...
#define IS_SOFTMODEM_OTFS            ( get_softmodem_optmask() & SOFTMODEM_OTFS_BIT)
